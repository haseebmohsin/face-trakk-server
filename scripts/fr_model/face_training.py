...
def main(opt):
    ...
    if opt.resume and not check_wandb_resume(opt):  # resume an interrupted run
        ...
        opt.save_dir = r"C:\Users\haseeb\Desktop\Forbmax Applications\facetrakk-app\facetrakk-server\scripts\fr_model\ptv_runs"
...
def process_data():
    ...
    for dirname, _, filenames in os.walk(r'C:\Users\haseeb\Desktop\Forbmax Applications\facetrakk-app\facetrakk-server\scripts\fr_model\Dataset\images'):
        for filename in filenames:
            img_paths.append(os.path.join(r'C:\Users\haseeb\Desktop\Forbmax Applications\facetrakk-app\facetrakk-server\scripts\fr_model\Dataset\images//', filename)) # local machine
    ...
    # write train.txt
    with open(r"C:\Users\haseeb\Desktop\Forbmax Applications\facetrakk-app\facetrakk-server\scripts\fr_model\Dataset//train.txt", 'w') as f:
        lines = list('\n'.join(train))
        f.writelines(lines)
    f.close

    # write validate.txt
    with open(r'C:\Users\haseeb\Desktop\Forbmax Applications\facetrakk-app\facetrakk-server\scripts\fr_model\Dataset//validate.txt', 'w') as f:
        lines = list('\n'.join(validate))
        f.writelines(lines)
    f.close
    ...
    f=open(r"C:\Users\haseeb\Desktop\Forbmax Applications\facetrakk-app\facetrakk-server\scripts\fr_model\Dataset\labels\classes.txt",'r')
    names=f.read().split('\n')
    f.close()
    # print(names)
    f=open(r'C:\Users\haseeb\Desktop\Forbmax Applications\facetrakk-app\facetrakk-server\scripts\fr_model\Dataset//data.yaml','w')
    f.write("train: C://Users//haseeb//Desktop//Forbmax Applications//facetrakk-app//facetrakk-server\scripts//fr_model//Dataset//train.txt/")
    f.write("\n")
    f.write("val: C://Users//haseeb//Desktop//Forbmax Applications//facetrakk-app//facetrakk-server\scripts//fr_model//Dataset//validate.txt/")
    f.write("\n")
...
def convert_pascal_to_yolo(pascal_dir, output_dir):
    ...
    # print("Conversion start xml to text")
...
def copy_images(source_folder, destination_folder,mode):
    print("copy images and xml")
    ...
    for file in files:
        # Check if the file is an image (you can modify this condition based on your file extensions)
        if file.lower().endswith((endwith)):
...
if __name__ == "__main__":
    ...
    dataset_dir = r"C:\Users\haseeb\Desktop\Forbmax Applications\facetrakk-app\facetrakk-server\scripts\dataset_generate"
    # Define the path to the output directory where augmented images and updated XML annotations will be saved
    output_dir = r"C:\Users\haseeb\Desktop\Forbmax Applications\facetrakk-app\facetrakk-server\scripts\dataset_generate"

    data_augment(dataset_dir,output_dir,100)

    if os.path.exists(r"C:\Users\haseeb\Desktop\Forbmax Applications\facetrakk-app\facetrakk-server\scripts\fr_model\Dataset"):
        shutil.rmtree(r"C:\Users\haseeb\Desktop\Forbmax Applications\facetrakk-app\facetrakk-server\scripts\fr_model\Dataset")
    ...
    copy_images(r"C:\Users\haseeb\Desktop\Forbmax Applications\facetrakk-app\facetrakk-server\scripts\dataset_generate",r"C:\Users\haseeb\Desktop\Forbmax Applications\facetrakk-app\facetrakk-server\scripts\fr_model\Dataset\images",'images')
    copy_images(r"C:\Users\haseeb\Desktop\Forbmax Applications\facetrakk-app\facetrakk-server\scripts\dataset_generate",r"C:\Users\haseeb\Desktop\Forbmax Applications\facetrakk-app\facetrakk-server\scripts\fr_model\Dataset\xmls",'xml')
    ...
    pascal_dir = r"C:\Users\haseeb\Desktop\Forbmax Applications\facetrakk-app\facetrakk-server\scripts\fr_model\Dataset\xmls"
    output_dir = r"C:\Users\haseeb\Desktop\Forbmax Applications\facetrakk-app\facetrakk-server\scripts\fr_model\Dataset\labels"

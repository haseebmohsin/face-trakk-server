...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=r"D:\vehicle datset and weighjts\our.pt", help='model.pt path(s)')
    parser.add_argument('--source', type=str, default=r"D:\192.168.1.15_IPC_20230224@12\3.mp4", help='file/dir/URL/glob, 0 for webcam')
